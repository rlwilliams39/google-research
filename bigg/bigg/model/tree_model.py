...
class RecurTreeGen(nn.Module):
    ...
    def forward_row_trees(self, graph_ids, node_feats=None, edge_feats=None, list_node_starts=None, num_nodes=-1, list_col_ranges=None):
        ...
        if self.has_edge_feats:
            ...
            print(edge_feats.shape)
            print(self.leaf_h0)
            print(self.leaf_h0.repeat(180, 1).shape)
            E = edge_feats.shape[0]
            edge_feats = self.merge_weight((edge_feats, edge_feats), (self.leaf_h0.repeat(E, 1), self.leaf_c0.repeat(E, 1)))
            print(edge_feats.shape)
    ...
    def forward_train(self, graph_ids, node_feats=None, edge_feats=None,
        ...
        if self.has_edge_feats:
            ...
            edge_feats_embed = self.merge_weight((edge_feats_embed, edge_feats_embed), (self.leaf_h0, self.leaf_c0))
