    ...
    def gen_row(self, ll, state, tree_node, col_sm, lb, ub, edge_feats=None, weight_state=None):
        ...
        if tree_node.is_leaf:
            ...
            if has_left:
                ...
                ll, left_state, num_left, left_edge_feats = self.gen_row(ll, state, tree_node.lch, col_sm, llb, lub, edge_feats, weight_state)
            ...
            if has_right:  # has edge in right child
                ll, right_state, num_right, right_edge_feats = self.gen_row(ll, topdown_state, tree_node.rch, col_sm, rlb, rub, edge_feats, weight_state)
